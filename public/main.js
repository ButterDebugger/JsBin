import { strictEquals } from "https://esm.sh/jsr/@debutter/helper";
...
function assert(result, expected, message = "") {
    ...
    // Add failure element
    const ele = document.createElement("p");
    ele.innerText = `❌ ${message} failed`;
    ele.title = "Check the console for more info";
    document.body.appendChild(ele);
}
